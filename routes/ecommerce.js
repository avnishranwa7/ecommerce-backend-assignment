...
router.put('/cart/add-to-cart', isAuth, addToCart);
router.put('/cart/update-product', isAuth, updateProductQuantity);
router.put('/cart/remove-product', isAuth, removeProductFromCart);
